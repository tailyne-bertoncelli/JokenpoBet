...
namespace desafio.Migrations
{
    ...
    [Migration("20241012213400_AddWalletInUser")]
    partial class AddWalletInUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("desafio.Entities.Wallet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("desafio.Entities.Wallet", b =>
                {
                    b.HasOne("desafio.Entities.User", "User")
                        .WithOne("Wallet")
                        .HasForeignKey("desafio.Entities.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
